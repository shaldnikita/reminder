package ru.shaldnikita.users.users.port.adapter.dao
...
import ru.shaldnikita.users.port.adapter.dao.contact.ContactsTable
import ru.shaldnikita.users.port.adapter.dao.user.UsersTable
import ru.shaldnikita.users.users.port.adapter.dao.contact.ContactsTable
import ru.shaldnikita.users.users.port.adapter.dao.user.UsersTable
