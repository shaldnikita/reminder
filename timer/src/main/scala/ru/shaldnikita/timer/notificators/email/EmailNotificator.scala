package ru.shaldnikita.timer.notificators.email

import org.apache.commons.mail._
import ru.shaldnikita.timer.dao.entities.User
import ru.shaldnikita.timer.notificators.Notificator
import ru.shaldnikita.timer.notificators.email.MailType.{MultiPart, Plain, Rich}
import ru.shaldnikita.timer.notificators.email.conf.EmailConfiguration
